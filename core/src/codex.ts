...
function taskPrompt(contract: AdapterTaskContract): string {
  return [
    ...
    "Implement the requested outcome, run proportionate checks, write the matching report, append exactly one matching log row, and make one local exact-path commit when Git isolation is clear.",
