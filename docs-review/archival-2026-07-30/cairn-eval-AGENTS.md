...
> **What this is.** Cairn Contract v0.2.0 is the small rulebook for AI work in this
...
WHAT WE ARE BUILDING: a simple website where I can list the books I own and mark the ones I have finished
WHO WILL USE IT: me, and my sister who borrows books from me
CURRENT MILESTONE: I can add a book without opening any files myself
```

`ACTIVE` means work may proceed. `PAUSED` means the owner has explicitly frozen
product work; the owner resumes it by saying so.

> **Archived by owner direction on 2026-07-30** (status added in Cairn Contract
> v0.5.0). This project's records stay as evidence; no work proceeds until the
> owner reactivates it. Note: this project's contract copy is v0.2.0 — on
> reactivation, the first task is adopting the current template.
