...
WHAT WE ARE BUILDING: An app where you drop a ball onto the floor
WHO WILL USE IT: Just me
CURRENT MILESTONE: The ball falling on the floor
...
> owner reactivates it. Note: this project's contract copy is the retired
> pre-reset v1.2 — on reactivation, adopt the current template first.
